...
def classify_triangle(side_length1, side_length2, side_length3):
    ...
    if (isinstance(side_length1, str) or\
        isinstance(side_length2, str) or\
        isinstance(side_length3, str)) or\
        (side_length1* side_length2 * side_length3) <= 0:
        return 'InvalidInput'
    ...
    if ((side_length1 ** 2) + (side_length2 ** 2)) == (side_length3 ** 2) or\
        ...
        return 'Right'
    if (side_length1 != side_length2) and  (side_length2 != side_length3) and\
